...
static const _ChatGPT_Request_type_support_symbol_names_t _ChatGPT_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, ChatGPT_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, ChatGPT_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, ChatGPT_Request)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::ChatGPT_Request_message_type_support_handle;
}
...
static const _ChatGPT_Response_type_support_symbol_names_t _ChatGPT_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, ChatGPT_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, ChatGPT_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, ChatGPT_Response)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::ChatGPT_Response_message_type_support_handle;
}
...
static const _ChatGPT_type_support_symbol_names_t _ChatGPT_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, ChatGPT)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, ChatGPT)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, ChatGPT)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::ChatGPT_service_type_support_handle;
}
