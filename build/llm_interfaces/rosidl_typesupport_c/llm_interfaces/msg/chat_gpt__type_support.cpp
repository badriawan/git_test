...
static const _ChatGPT_type_support_symbol_names_t _ChatGPT_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, msg, ChatGPT)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, msg, ChatGPT)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, msg, ChatGPT)() {
  return &::llm_interfaces::msg::rosidl_typesupport_c::ChatGPT_message_type_support_handle;
}
